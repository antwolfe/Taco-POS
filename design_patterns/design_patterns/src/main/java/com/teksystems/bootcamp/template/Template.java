...
public abstract class Template {
    ...
    final void tellMeAStory() {
        ...
        System.out.println("As I was " + getPastTenseVerb() + " on the " + getFurnitureObject() + ", I saw a " + getColor() + " " + getAnimal() + " make it's way into the " + getPlace()+ ".");
        ...
        System.out.println("It almost worked! But one of the " + getAnimals() + " " + getPastTenseVerb() + " and grabbed a " + getAdjective() + " " + getObject() + " that came crashing down onto the " + getAnimal() + "'s head.");

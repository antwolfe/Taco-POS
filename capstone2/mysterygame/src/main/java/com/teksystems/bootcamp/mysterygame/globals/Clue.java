...
public enum Clue { // TODO: add keywords from InteractiveItems
    ...
    MUD_STAINS("The mud here is in the shape of dog paws."), // dirt
    PHONE_CALL("You witness a phone conversation between 'Guy' and his wife. It's their anniversary."), // listen
